...
bool intersect (double line1x1, double line1y1, double line1x2, double line1y2,
		double line2x1, double line2y1, double line2x2, double line2y2, double tol = 0.0001); 

bool intersect (doublet line1p1, doublet line1p2, doublet line2p1, doublet line2p2, double tol = 0.0001);
