...
bool intersect (double line1x1, double line1y1, double line1x2, double line1y2,
		double line2x1, double line2y1, double line2x2, double line2y2, double tol) {
  ...
  if (xinter < std::min(line1x1, line1x2) - tol) return false;
...
bool intersect (doublet line1p1, doublet line1p2, doublet line2p1, doublet line2p2, double tol) {
  return intersect(line1p1.x(), line1p1.y(), line1p2.x(), line1p2.y(),
                   line2p1.x(), line1p1.y(), line2p2.x(), line2p2.y(),
                   tol);
}
